...
class LLMDiary:
    ...
    async def ai_llm_label_model_run(self, input: str, config: dict) -> str:
        ...
        prompt = ChatPromptTemplate.from_template("""[Instruction]
                                                    ...
                                                    - 아이감정: 기쁘다, 화나다, 슬프다, 무섭다, 심심하다, 짜증나다 중 오직 하나만 선택
                                                    - 육아범주 : 수면, 식사, 사회성, 운동, 언어, 배변, 정서, 인지, 건강, 의복 이 중에서 가장 적합성이 높은 하나만 선택하세요.                                                
                                                    ...
                                                    [
                                                    {{
                                                        "원본": "오전 이유식 한 숟가락 먹고 입을 꾹 닫음. 남은 미음은 양손으로 다 엎어서 본의 아니게 촉감 놀이 파티함. 치우느라 영혼 탈탈 털렸으나 목욕 후 기분 찢어짐.",
                                                        "핵심어": "오전, 이유식, 먹다, 입, 닫다, 남다, 미음, 양손, 엎다. 촉감놀이, 치우다, 목욕, 기분 찢어짐",
                                                        "부모감정": "답답하다",
                                                        "아이감정": "짜증나다",
                                                        "식사": "이유식 미음",
                                                        "배변": "없음",
                                                    ...
                                                    {{
                                                        "원본": "오후 간식 퓨레는 다행히 순삭하고 응가도 시원하게 성공. 내일은 제발 한 그릇 다 비워주라.",
                                                        "핵심어": "오후, 간식 퓨레, 순삭, 응가, 성공, 내일, 한 그릇, 비우다",
                                                        "부모감정": "평온하다",
                                                        "아이감정": "기쁘다",
                                                        "식사": "간식 퓨레",
                                                        "배변": "응가 1회",
                                                    ...
                                                    [
                                                    {{
                                                        "원본": "오전 접종 열차 타고 와서 그런지 낮부터 계속 품에만 안겨 있으려고 함.",
                                                        "핵심어": "오전, 접종 열차, 타고 오다, 낮, 품에, 안기다",
                                                        "부모감정": "걱정되다",
                                                        "아이감정": "무섭다",
                                                        "식사": "없음",
                                                        "배변": "없음",
                                                    ...
                                                    {{
                                                        "원본": "눕히면 등 센서 발동해서 오후 내내 인간 침대 노릇 함.",
                                                        "핵심어": "눕히다, 등 센서, 발동하다, 오후, 인간 침대 노릇, 하다",
                                                        "부모감정": "지치다",
                                                        "아이감정": "무섭다",
                                                        "식사": "없음",
                                                        "배변": "없음",
                                                    ...
                                                    {{
                                                        "원본": "다행히 저녁 체온 37.1도로 미열 수준 유지 중. 밤새 열 오르지 않고 무사히 넘어가길 바라며 해열제 대기 완료. 내일은 컨디션 회복하자.",
                                                        "핵심어": "저녁, 체온 37.1, 미열, 열, 오르지 않다, 넘어가다, 바라다, 해열제, 대기, 내일, 컨디션, 회복하다",
                                                        "부모감정": "걱정되다",
                                                        "아이감정": "무섭다",
                                                        "식사": "없음",
                                                        "배변": "없음",
    ...
    async def ai_llm_story_model_run(self, input: str, config: dict) -> str:
        ...
        try:
            ...
            raw_story = await chain.ainvoke({"input": input})
